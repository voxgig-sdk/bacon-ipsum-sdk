...
from baconipsum_sdk.core.spec import BaconIpsumSpec
from baconipsum_sdk.core.result import BaconIpsumResult
from baconipsum_sdk.core.response import BaconIpsumResponse
from baconipsum_sdk.core.operation import BaconIpsumOperation
from baconipsum_sdk.core.error import BaconIpsumError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BaconIpsumError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = BaconIpsumSDK.test(None, None)
        ...
        class TestInitFeature(BaconIpsumBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BaconIpsumBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BaconIpsumSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BaconIpsumSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BaconIpsumSDK.test(None, setup_opts)
