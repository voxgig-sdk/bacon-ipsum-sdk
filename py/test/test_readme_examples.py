# BaconIpsum SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BaconIpsumSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BaconIpsumSDK(...) and BaconIpsumSDK.test(...) become
#      BaconIpsumSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "baconipsum_sdk"
_SDK_CLASS = "BaconIpsumSDK"
