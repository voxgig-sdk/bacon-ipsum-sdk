...
class BaconIpsumTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BaconIpsumTestRunner.getenv("BACONIPSUM_TEST_LIVE")
        override = BaconIpsumTestRunner.getenv("BACONIPSUM_TEST_OVERRIDE")
        ...
        explain = BaconIpsumTestRunner.getenv("BACONIPSUM_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["BACONIPSUM_TEST_EXPLAIN"] = explain
