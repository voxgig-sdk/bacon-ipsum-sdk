...
from baconipsum_sdk.core.control import BaconIpsumControl
...
from baconipsum_sdk.core.helpers import get_ctx_prop, to_map
...
class BaconIpsumContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BaconIpsumSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BaconIpsumResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BaconIpsumResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BaconIpsumError(code, msg, self)
