...
from baconipsum_sdk.utility import register

# Load features
from baconipsum_sdk.feature.base_feature import BaconIpsumBaseFeature
from baconipsum_sdk.features import _has_feature, _make_feature
...
class BaconIpsumSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BaconIpsumUtility()
        self._utility = utility

        from baconipsum_sdk.config import shared_config
    ...
    def get_utility(self):
        return BaconIpsumUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BaconIpsumSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def TextGeneration(self, data=None) -> "TextGenerationEntity":
        ...
        from baconipsum_sdk.entity.text_generation_entity import TextGenerationEntity
