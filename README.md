...
The Bacon Ipsum JSON API is a REST interface for generating meaty lorem ipsum text that can be utilized by any application.

Learn more about Bacon Ipsum API at [baconipsum.com/json-api](https://baconipsum.com/json-api/).
...
This SDK exposes the API as a small set of **semantic entities** — TextGeneration — that you
