...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/bacon-ipsum` | `npm install @voxgig-sdk/bacon-ipsum` |
| Python | `voxgig-sdk-bacon-ipsum` | `pip install voxgig-sdk-bacon-ipsum` |
| PHP | `voxgig-sdk/bacon-ipsum` | `composer require voxgig-sdk/bacon-ipsum` |
| Golang | `github.com/voxgig-sdk/bacon-ipsum-sdk/go` | `go get github.com/voxgig-sdk/bacon-ipsum-sdk/go` |
| Ruby | `voxgig-sdk-bacon-ipsum` | `gem install voxgig-sdk-bacon-ipsum` |
| Lua | `voxgig-sdk-bacon-ipsum` | `luarocks install voxgig-sdk-bacon-ipsum` |
