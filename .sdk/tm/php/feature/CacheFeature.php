...
class BaconIpsumCacheFeature extends BaconIpsumBaseFeature
{
    ...
    private function _through(BaconIpsumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
