...
class BaconIpsumProxyFeature extends BaconIpsumBaseFeature
{
    ...
    public function init(BaconIpsumContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BaconIpsumContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
