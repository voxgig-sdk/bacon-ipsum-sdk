...
class BaconIpsumRbacFeature extends BaconIpsumBaseFeature
{
    ...
    private function _required(BaconIpsumContext $ctx): ?string
    {
    ...
    private function _reject(BaconIpsumContext $ctx, string $required): void
    {
    ...
    private function _track(BaconIpsumContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
