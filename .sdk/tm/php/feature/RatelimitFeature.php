...
// BaconIpsum SDK ratelimit feature
...
class BaconIpsumRatelimitFeature extends BaconIpsumBaseFeature
{
    ...
    private function _acquire(BaconIpsumContext $ctx): void
    {
    ...
    private function _track(BaconIpsumContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
