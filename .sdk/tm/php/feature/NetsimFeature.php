...
class BaconIpsumNetsimFeature extends BaconIpsumBaseFeature
{
    ...
    private function _simulate(BaconIpsumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BaconIpsumContext $ctx, array $applied): void
    {
        $client = $this->client;
