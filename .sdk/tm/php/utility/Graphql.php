...
// BaconIpsum SDK utility: graphql
//
...
class BaconIpsumGraphql
{
    ...
    // equivalent.
    public static function body(BaconIpsumContext $ctx): mixed
    {
    ...
    public static function errors(BaconIpsumContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
