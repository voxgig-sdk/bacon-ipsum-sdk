...
|---|---|---|
| `ts/` | @voxgig-sdk/bacon-ipsum-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bacon-ipsum-sdk \
      --repository voxgig-sdk/bacon-ipsum-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bacon-ipsum-sdk` shows it, and
`npm trust revoke @voxgig-sdk/bacon-ipsum-sdk --id=<id>` removes it.
