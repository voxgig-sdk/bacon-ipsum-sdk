...
type Args struct {
	Entity string         `json:"entity" jsonschema:"text_generation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BaconIpsumSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bacon-ipsum_list",
		Description: "List records from BaconIpsum. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bacon-ipsum_load",
		Description: "Load a single record from BaconIpsum. " +
...
func runOp(client *sdk.BaconIpsumSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BaconIpsumSDK, name string) (sdk.BaconIpsumEntity, error) {
	switch strings.ToLower(name) {
	case "text_generation":
		return client.TextGeneration(nil), nil
