// Command BaconIpsum-mcp is an MCP server exposing the BaconIpsum
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BaconIpsum_list  — list records of an entity
//	BaconIpsum_load  — load a single record of an entity
//
