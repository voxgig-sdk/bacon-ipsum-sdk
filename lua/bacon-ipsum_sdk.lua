...
local BaconIpsumSDK = {}
BaconIpsumSDK.__index = BaconIpsumSDK
...
BaconIpsumSDK._make_feature = _make_feature


function BaconIpsumSDK.new(options)
  local self = setmetatable({}, BaconIpsumSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BaconIpsumSDK:options_map()
...
function BaconIpsumSDK:get_utility()
  return Utility.copy(self._utility)
end


function BaconIpsumSDK:get_root_ctx()
  return self._rootctx
end


function BaconIpsumSDK:prepare(fetchargs)
...
function BaconIpsumSDK:direct(fetchargs)
...
-- by passing it.
function BaconIpsumSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BaconIpsumSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "BaconIpsumSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function BaconIpsumSDK:TextGeneration(data)
  ...
  if data == nil then
    if self._text_generation == nil then
      self._text_generation = EntityMod.new(self, nil)
    end
...
function BaconIpsumSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BaconIpsumSDK.new(sdkopts)
  sdk.mode = "test"
