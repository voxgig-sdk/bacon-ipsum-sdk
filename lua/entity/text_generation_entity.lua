...
local TextGenerationEntity = {}
TextGenerationEntity.__index = TextGenerationEntity


function TextGenerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TextGenerationEntity)
  self._name = "text_generation"
  self._client = client
...
function TextGenerationEntity:get_name()
  return self._name
end


function TextGenerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TextGenerationEntity.new(self._client, opts)
end
...
function TextGenerationEntity:mark_deleted()
  self._deleted = true
end


function TextGenerationEntity:deleted()
  return true == self._deleted
end


function TextGenerationEntity:data_set(args)
  if args ~= nil then
...
function TextGenerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TextGenerationEntity:match_set(args)
  if args ~= nil then
...
function TextGenerationEntity:match_get()
...
function TextGenerationEntity:stream(action, args, callopts)
...
---@param reqmatch TextGenerationLoadMatch
---@param ctrl? table
---@return TextGeneration
---@return string? err
function TextGenerationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function TextGenerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
