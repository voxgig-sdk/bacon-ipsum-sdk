...
describe("TextGenerationDirect", function()
  it("should direct-load-text_generation", function()
    local setup = text_generation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-text_generation", setup.live and "live" or "unit")
...
function text_generation_direct_setup(mockres)
