...
function runner.env_override(m)
  local live = runner.getenv("BACON_IPSUM_TEST_LIVE")
  local override = runner.getenv("BACON_IPSUM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BACON_IPSUM_TEST_EXPLAIN")
