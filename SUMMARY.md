...
Results: Successfully generated bacon ipsum text.
...
| --- | --- | --- | --- |
| TextGeneration | `load` | `GET /api/` | See reference |

## Connect to the API

- Production server: `https://baconipsum.com`
...
- `bacon-ipsum_list`: List records for an entity. No active entity supports this operation.
- `bacon-ipsum_load`: Load one record for an entity. Supported entities: `text_generation`.
