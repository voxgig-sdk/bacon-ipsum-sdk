...
function envOverride(m) {
    if ('TRUE' === process.env.BACON_IPSUM_TEST_LIVE ||
        'TRUE' === process.env.BACON_IPSUM_TEST_OVERRIDE) {
    ...
    m.BACON_IPSUM_TEST_EXPLAIN = process.env.BACON_IPSUM_TEST_EXPLAIN || m.BACON_IPSUM_TEST_EXPLAIN;
    return m;
}
