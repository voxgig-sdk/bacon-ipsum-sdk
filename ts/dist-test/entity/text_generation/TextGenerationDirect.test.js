...
(0, node_test_1.describe)('TextGenerationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BaconIpsumSDK({
    ...
    (0, node_test_1.test)('direct-load-text_generation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-text_generation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BACON_IPSUM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BaconIpsumSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BACON_IPSUM_TEST_TEXT_GENERATION_ENTID'];
    ...
    const client = new __1.BaconIpsumSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TextGenerationDirect.test.js.map