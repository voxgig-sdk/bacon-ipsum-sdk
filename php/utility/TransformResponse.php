...
// BaconIpsum SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BaconIpsumTransformResponse
{
    public static function call(BaconIpsumContext $ctx): mixed
    {
        ...
        $transform = BaconIpsumHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
