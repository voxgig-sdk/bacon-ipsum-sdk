...
// BaconIpsum SDK utility: fetcher

class BaconIpsumFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BaconIpsumSDK/1.0)';
    ...
    public static function call(BaconIpsumContext $ctx, string $fullurl, array $fetchdef): array
    {
