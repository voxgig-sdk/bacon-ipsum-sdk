...
// BaconIpsum SDK idempotency feature
...
class BaconIpsumIdempotencyFeature extends BaconIpsumBaseFeature
{
    ...
    private function _mutating(BaconIpsumContext $ctx): bool
    {
