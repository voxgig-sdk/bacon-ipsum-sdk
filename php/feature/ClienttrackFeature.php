...
// BaconIpsum SDK clienttrack feature
...
class BaconIpsumClienttrackFeature extends BaconIpsumBaseFeature
{
    ...
    public function PostConstruct(BaconIpsumContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BaconIpsum-SDK';
