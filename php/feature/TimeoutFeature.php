...
// BaconIpsum SDK timeout feature
...
class BaconIpsumTimeoutFeature extends BaconIpsumBaseFeature
{
    ...
    private function _with_timeout(BaconIpsumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BaconIpsumContext $_ctx, float $ms): void
    {
        $client = $this->client;
