...
// BaconIpsum SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BaconIpsumTestFeature extends BaconIpsumBaseFeature
{
    ...
    public function init(BaconIpsumContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BaconIpsumContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BaconIpsumParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BaconIpsumContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BaconIpsumContext $ctx, $op, $args): array
    {
