...
// BaconIpsum SDK streaming feature
...
class BaconIpsumStreamingFeature extends BaconIpsumBaseFeature
{
    ...
    private function _iterate(BaconIpsumResult $result): \Generator
    {
    ...
    private function _streamable(BaconIpsumContext $ctx): bool
    {
