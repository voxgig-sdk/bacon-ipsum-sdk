...
class TextGenerationDirectTest extends TestCase
{
    public function test_direct_load_text_generation(): void
    {
        $setup = text_generation_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-text_generation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
