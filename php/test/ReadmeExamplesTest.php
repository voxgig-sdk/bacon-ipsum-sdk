...
// BaconIpsum SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BaconIpsumSDK::test)
...
{
    private const SDK_CLASS = 'BaconIpsumSDK';
    ...
    private const SDK_BASE = 'baconipsum_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../baconipsum_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
