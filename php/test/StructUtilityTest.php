...
// BaconIpsum SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BaconIpsumOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BaconIpsumOmni::structfix($now, Struct::undef()))
                        !== json_encode(BaconIpsumOmni::structfix($val, Struct::undef()))) {
