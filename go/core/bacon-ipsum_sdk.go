...
func (sdk *BaconIpsumSDK) OptionsMap() map[string]any {
...
func (sdk *BaconIpsumSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BaconIpsumSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BaconIpsumSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BaconIpsumSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BaconIpsumSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BaconIpsumSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BaconIpsumSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BaconIpsumSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BaconIpsumSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BaconIpsumSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
