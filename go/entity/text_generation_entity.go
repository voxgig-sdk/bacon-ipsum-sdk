...
import (
	...
	vs "github.com/voxgig-sdk/bacon-ipsum-sdk/go/utility/struct"
)

type TextGenerationEntity struct {
	name    string
	client  *core.BaconIpsumSDK
...
func NewTextGenerationEntity(client *core.BaconIpsumSDK, entopts map[string]any) *TextGenerationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TextGenerationEntity) GetName() string { return e.name }
...
func (e *TextGenerationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TextGenerationEntity) Deleted() bool {
	return e.deleted
}


func (e *TextGenerationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTextGenerationEntity(e.client, opts)
}

func (e *TextGenerationEntity) Data(args ...any) any {
...
func (e *TextGenerationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TextGeneration; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TextGenerationEntity) DataTyped(data ...TextGeneration) TextGeneration {
	if len(data) > 0 {
		return typedFrom[TextGeneration](e.Data(asMap(data[0])))
	}
	return typedFrom[TextGeneration](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TextGeneration (all fields
// optional at the wire level).
func (e *TextGenerationEntity) MatchTyped(match ...TextGeneration) TextGeneration {
	if len(match) > 0 {
		return typedFrom[TextGeneration](e.Match(asMap(match[0])))
	}
	return typedFrom[TextGeneration](e.Match())
}
...
func (e *TextGenerationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TextGenerationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TextGenerationLoadMatch and returns an TextGeneration. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TextGenerationEntity) LoadTyped(reqmatch TextGenerationLoadMatch, ctrl map[string]any) (TextGeneration, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TextGeneration{}, err
	}
	return typedFrom[TextGeneration](res), nil
}



func (e *TextGenerationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TextGenerationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TextGenerationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TextGenerationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TextGenerationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
