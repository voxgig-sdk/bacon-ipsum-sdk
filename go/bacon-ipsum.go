...
// instead of `sdk.NewBaconIpsumSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *BaconIpsumSDK  { return NewBaconIpsumSDK(nil) }
func Test() *BaconIpsumSDK { return TestSDK(nil, nil) }
