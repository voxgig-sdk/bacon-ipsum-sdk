...
class TextGenerationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BACONIPSUM_TEST_TEXT_GENERATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def text_generation_basic_setup(extra)
  ...
  entid_env_raw = ENV["BACONIPSUM_TEST_TEXT_GENERATION_ENTID"]
