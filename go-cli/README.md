...
AQL-driven CLI and REPL for the BaconIpsum SDK. Positional arguments are
...
./bacon-ipsum-cli list text_generation
./bacon-ipsum-cli load 1 text_generation
./bacon-ipsum-cli load '{id:1}' text_generation
