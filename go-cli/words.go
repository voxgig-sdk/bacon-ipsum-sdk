...
func registerSDKWords(r *eng.Registry, client *sdk.BaconIpsumSDK) {
...
func runOp(client *sdk.BaconIpsumSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
